...
function ProfileSkeleton() {
    return (
        <div className="bg-white dark:bg-white/[0.04] border border-slate-200 dark:border-white/10 rounded-2xl shadow-sm overflow-hidden animate-pulse">
        ...
        <div className="space-y-7 pb-12 w-full">
            ...
            {loading && !shouldMockMe ? <ProfileSkeleton /> : (
                <div className="bg-white dark:bg-white/[0.04] border border-slate-200 dark:border-white/10 rounded-2xl shadow-sm overflow-hidden">
                    ...
                    <div className="p-6">
                        <div className="flex items-center gap-5">
                            {/* Avatar — Var A gradient */}
                            <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-blue-600 to-violet-600 flex items-center justify-center text-white font-extrabold text-2xl shadow-md shadow-blue-500/30 shrink-0">
                            ...
                            <div>
                                {clipperData?.bank_no ? (
                                    <>
                                        ...
                                        <p className="text-sm text-slate-500 dark:text-slate-400 font-medium mt-0.5 font-mono">{clipperData.bank_no}</p>
                        ...
                        <form onSubmit={handleSaveBank} className="space-y-4">
                            ...
                            <div className="flex gap-3 pt-1">
                                <button
                                    ...
                                    className="flex items-center gap-2 bg-gradient-to-r from-blue-600 to-violet-600 hover:opacity-90 text-white font-bold text-sm px-5 py-2.5 rounded-xl transition-opacity disabled:opacity-60"
                                >
                                    <Save size={15} />
                ...
                <div className="bg-white dark:bg-white/[0.04] border border-slate-200 dark:border-white/10 rounded-2xl shadow-sm overflow-hidden">
                    ...
                    <div className="p-6 grid grid-cols-2 sm:grid-cols-4 gap-4">
                        <StatItem
                            icon={<Eye size={20} />}
                            label={s.totalViews}
                            value={fmtViews(clipperData?.total_views ?? 0)}
                        ...
                        <StatItem
                            ...
                            label={s.totalEarned}
                            value={`฿${fmt(clipperData?.total_earnings ?? 0)}`}
                        ...
                        <StatItem
                            ...
                            label={s.paidOut}
                            value={`฿${fmt(clipperData?.paid_amount ?? 0)}`}
                        ...
                        <StatItem
                            ...
                            value={`฿${fmt(clipperData?.pending_balance ?? 0)}`}
...
function StatItem({ icon, label, value, iconBg, iconColor, monospace }: {
    ...
    return (
        <div className="text-center">
            ...
            <p className={`text-lg font-extrabold text-slate-900 dark:text-slate-100 ${monospace ? "font-mono" : ""}`}>{value}</p>
