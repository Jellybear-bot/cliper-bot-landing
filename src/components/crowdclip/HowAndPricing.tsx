...
export function HowItWorks() {
  ...
  const steps = [
    ...
    { n: "02", title: "ครีเอเตอร์ 100+ คนรีมิกซ์ + โพสต์", body: "เครือข่ายครีเอเตอร์ไทยรีมิกซ์ในสไตล์ตัวเอง โพสต์พร้อมกันบน TikTok, YouTube Shorts ครอบคลุมหลายกลุ่มเป้าหมาย", tag: "วันที่ 3–10", color: T.orange },
  ...
  const plans = [
    {
      ...
      features: ["ครีเอเตอร์ 30+ คน", "โพสต์ทั้ง 2 แพลตฟอร์ม", "Dashboard ติดตามผลเรียลไทม์", "รายงานสรุปท้ายแคมเปญ"],
    },
    {
